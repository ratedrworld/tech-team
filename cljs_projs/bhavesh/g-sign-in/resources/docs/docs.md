...
The `home-routes` handler in the `g-sign-in.routes.home` namespace
...
The `home-page` function will in turn call the `g-sign-in.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/g_sign_in/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `g-sign-in.handler` namespace:
...
Request middleware functions are located under the `g-sign-in.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `g-sign-in.dev-middleware` namespace found in
