...
struct.core.dissoc_in = (function struct$core$dissoc_in(m,p__45494){
...
return cljs.core.reduce.call(null,(function (p1__45498_SHARP_,p2__45499_SHARP_){
return cljs.core.conj_BANG_.call(null,p1__45498_SHARP_,struct.core.build_step.call(null,key,p2__45499_SHARP_));
}),acc,value);
} else {
return cljs.core.conj_BANG_.call(null,acc,struct.core.build_step.call(null,key,value));
}
});
struct.core.normalize_step_entry = (function struct$core$normalize_step_entry(acc,p__45502){
var vec__45503 = p__45502;
var seq__45504 = cljs.core.seq.call(null,vec__45503);
var first__45505 = cljs.core.first.call(null,seq__45504);
var seq__45504__$1 = cljs.core.next.call(null,seq__45504);
var key = first__45505;
var values = seq__45504__$1;
return cljs.core.reduce.call(null,((function (vec__45503,seq__45504,first__45505,seq__45504__$1,key,values){
return (function (p1__45500_SHARP_,p2__45501_SHARP_){
return cljs.core.conj_BANG_.call(null,p1__45500_SHARP_,struct.core.build_step.call(null,key,p2__45501_SHARP_));
});})(vec__45503,seq__45504,first__45505,seq__45504__$1,key,values))
,acc,values);
});
...
var G__45506 = skip;
var G__45507 = errors;
var G__45508 = data__$1;
var G__45509 = cljs.core.rest.call(null,steps__$1);
skip = G__45506;
errors = G__45507;
data__$1 = G__45508;
steps__$1 = G__45509;
...
if(cljs.core.truth_((function (){var and__39148__auto__ = (value == null);
...
var G__45510 = skip;
var G__45511 = errors;
var G__45512 = data__$1;
var G__45513 = cljs.core.rest.call(null,steps__$1);
skip = G__45510;
errors = G__45511;
data__$1 = G__45512;
steps__$1 = G__45513;
...
var G__45514 = skip;
var G__45515 = errors;
var G__45516 = cljs.core.assoc_in.call(null,data__$1,path,value__$1);
var G__45517 = cljs.core.rest.call(null,steps__$1);
skip = G__45514;
errors = G__45515;
data__$1 = G__45516;
steps__$1 = G__45517;
...
var G__45518 = cljs.core.conj.call(null,skip,path);
var G__45519 = cljs.core.assoc_in.call(null,errors,path,message);
var G__45520 = struct.core.dissoc_in.call(null,data__$1,path);
var G__45521 = cljs.core.rest.call(null,steps__$1);
skip = G__45518;
errors = G__45519;
data__$1 = G__45520;
steps__$1 = G__45521;
...
struct.core.validate.cljs$core$IFn$_invoke$arity$3 = (function (data,schema,p__45524){
...
var strip = cljs.core.get.call(null,map__45525__$1,new cljs.core.Keyword(null,"strip","strip",632627960),false);
...
struct.core.validate_BANG_.cljs$core$IFn$_invoke$arity$3 = (function (data,schema,p__45533){
...
var opts = map__45534__$1;
var message = cljs.core.get.call(null,map__45534__$1,new cljs.core.Keyword(null,"message","message",-406056002),"Schema validation error");
var vec__45536 = struct.core.validate.call(null,data,schema,opts);
var errors = cljs.core.nth.call(null,vec__45536,(0),null);
var data__$1 = cljs.core.nth.call(null,vec__45536,(1),null);
...
struct.core.uuid = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"must be an uuid",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__45541_SHARP_){
return (p1__45541_SHARP_ instanceof cljs.core.UUID);
})], null);
struct.core._PLUS_uuid_re_PLUS_ = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/;
struct.core.uuid_str = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"message","message",-406056002),"must be an uuid",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__45542_SHARP_){
var and__39148__auto__ = typeof p1__45542_SHARP_ === 'string';
if(and__39148__auto__){
return cljs.core.re_seq.call(null,/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/,p1__45542_SHARP_);
} else {
return and__39148__auto__;
}
}),new cljs.core.Keyword(null,"coerce","coerce",1917884504),(function (p1__45544_SHARP_){
return struct.core.uuid.call(null,p1__45544_SHARP_);
})], null);
...
var and__39148__auto__ = typeof p1__45545_SHARP_ === 'string';
if(and__39148__auto__){
return cljs.core.re_seq.call(null,rx,p1__45545_SHARP_);
} else {
return and__39148__auto__;
}
});})(rx))
...
struct.core.required = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"this field is mandatory",new cljs.core.Keyword(null,"optional","optional",2053951509),false,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__45546_SHARP_){
if(typeof p1__45546_SHARP_ === 'string'){
return !(cljs.core.empty_QMARK_.call(null,p1__45546_SHARP_));
} else {
return !((p1__45546_SHARP_ == null));
}
})], null);
...
struct.core.number_str = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"message","message",-406056002),"must be a number",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__45547_SHARP_){
var and__39148__auto__ = typeof p1__45547_SHARP_ === 'string';
if(and__39148__auto__){
return cljs.core.re_seq.call(null,/^[-+]?[0-9]*\.?[0-9]+$/,p1__45547_SHARP_);
} else {
return and__39148__auto__;
}
}),new cljs.core.Keyword(null,"coerce","coerce",1917884504),(function (p1__45548_SHARP_){
return parseFloat(p1__45548_SHARP_);
})], null);
...
var and__39148__auto__ = typeof v === 'string';
if(and__39148__auto__){
...
struct.core.boolean$ = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"must be a boolean",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__45550_SHARP_){
return (cljs.core._EQ_.call(null,false,p1__45550_SHARP_)) || (cljs.core._EQ_.call(null,true,p1__45550_SHARP_));
})], null);
...
struct.core.every = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"must match the predicate",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__45552_SHARP_,p2__45551_SHARP_){
return cljs.core.every_QMARK_.call(null,p2__45551_SHARP_,p1__45552_SHARP_);
})], null);
struct.core.member = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"not in coll",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__45553_SHARP_,p2__45554_SHARP_){
return cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([p1__45553_SHARP_]),p2__45554_SHARP_);
})], null);
