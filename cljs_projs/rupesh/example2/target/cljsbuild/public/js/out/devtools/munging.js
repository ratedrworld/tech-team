...
var o42579 = temp__4655__auto__;
var temp__4655__auto____$1 = (o42579["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o42580 = temp__4655__auto____$1;
return (o42580["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41723__auto__ = f;
return (o__41723__auto__["toString"]).call(o__41723__auto__);
} else {
return "";
}
}catch (e42581){var _ = e42581;
return "";
}});
...
try{var o__41723__auto___42583 = t;
(o__41723__auto___42583["cljs$lang$ctorPrWriter"]).call(o__41723__auto___42583,t,writer);
}catch (e42582){var __42584 = e42582;
}
...
var char_code = (function (){var o__41723__auto__ = (new String(char$));
return (o__41723__auto__["charCodeAt"]).call(o__41723__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41723__auto__ = String;
return (o__41723__auto__["fromCharCode"]).call(o__41723__auto__,subscript_code);
});
/**
...
var o__41723__auto__ = String;
return (o__41723__auto__["fromCharCode"]).call(o__41723__auto__,superscript_code);
});
/**
...
}catch (e42587){var _e__41730__auto__ = e42587;
return false;
}})())){
...
var vec__42588 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__42588,(0),null);
...
var or__39160__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o42591 = temp__4655__auto__;
var temp__4655__auto____$1 = (o42591["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o42592 = temp__4655__auto____$1;
return (o42592["nameToPath"]);
} else {
return null;
}
} else {
...
var len__40324__auto___42599 = arguments.length;
var i__40325__auto___42600 = (0);
while(true){
if((i__40325__auto___42600 < len__40324__auto___42599)){
args__40331__auto__.push((arguments[i__40325__auto___42600]));

var G__42601 = (i__40325__auto___42600 + (1));
i__40325__auto___42600 = G__42601;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__40332__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42595){
var vec__42596 = p__42595;
var ns_detector = cljs.core.nth.call(null,vec__42596,(0),null);
var effective_detector = (function (){var or__39160__auto__ = ns_detector;
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
} else {
...
var G__42602 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__42603 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__42602;
remaining_tokens = G__42603;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42593){
var G__42594 = cljs.core.first.call(null,seq42593);
var seq42593__$1 = cljs.core.next.call(null,seq42593);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__42594,seq42593__$1);
});
...
var vec__42607 = cljs.core.split_with.call(null,(function (p1__42606_SHARP_){
return cljs.core.not_EQ_.call(null,p1__42606_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__42607,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__42607,(1),null);
...
var vec__42610 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__42610,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__42610,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__42613 = cljs.core.rest.call(null,remaining_tokens);
var G__42614 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__42613;
name_tokens = G__42614;
continue;
} else {
...
var vec__42617 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__42617,(0),null);
var arity = cljs.core.nth.call(null,vec__42617,(1),null);
var vec__42620 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__42620,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__42620,(1),null);
var vec__42623 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__42623,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__42623,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__42623,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__42623,(3),null);
...
var vec__42629 = result;
var munged_ns = cljs.core.nth.call(null,vec__42629,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__42629,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__42629,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__42629,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__42629,(4),null);
var arity = cljs.core.nth.call(null,vec__42629,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__42633 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__42633,(0),null);
var args = cljs.core.nth.call(null,vec__42633,(1),null);
var vec__42636 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__42636,(0),null);
var name = cljs.core.nth.call(null,vec__42636,(1),null);
...
var G__42639 = (arity + (1));
var G__42640 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42641){
var vec__42642 = p__42641;
var arity = cljs.core.nth.call(null,vec__42642,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__42642,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__39160__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
} else {
...
return (function (p1__42645_SHARP_){
return cljs.core.get.call(null,arities,p1__42645_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__42646_SHARP_);
...
var args__40331__auto__ = [];
var len__40324__auto___42653 = arguments.length;
var i__40325__auto___42654 = (0);
while(true){
if((i__40325__auto___42654 < len__40324__auto___42653)){
args__40331__auto__.push((arguments[i__40325__auto___42654]));

var G__42655 = (i__40325__auto___42654 + (1));
i__40325__auto___42654 = G__42655;
continue;
} else {
}
break;
...
var argseq__40332__auto__ = ((((1) < args__40331__auto__.length))?(new cljs.core.IndexedSeq(args__40331__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__40332__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42649){
var vec__42650 = p__42649;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__42650,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42647){
var G__42648 = cljs.core.first.call(null,seq42647);
var seq42647__$1 = cljs.core.next.call(null,seq42647);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__42648,seq42647__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__39160__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__39148__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__39160__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__42658__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__42658__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__42658__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__42658__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42659 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__42659,(0),null);
var fn_name = cljs.core.nth.call(null,vec__42659,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__42659,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__42659,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__42659,(4),null);
var arity = cljs.core.nth.call(null,vec__42659,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__39148__auto__ = protocol_ns;
if(cljs.core.truth_(and__39148__auto__)){
return cljs.core.not.call(null,(function (){var and__39148__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__39160__auto__ = protocol_part;
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
} else {
return fn_part;
...
var o__41723__auto__ = f;
return (o__41723__auto__["getBasis"]).call(o__41723__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__39148__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__39148__auto__)){
...
}catch (e42663){var _e__41730__auto__ = e42663;
...
var G__42664 = (obj[cljs.core.first.call(null,path)]);
var G__42665 = cljs.core.rest.call(null,path);
obj = G__42664;
path = G__42665;
continue;
} else {
...
var partition_bits = (function (){var or__39160__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
} else {
return (0);
...
return (function (accum,p__42666){
var vec__42667 = p__42666;
var bit = cljs.core.nth.call(null,vec__42667,(0),null);
var protocol = cljs.core.nth.call(null,vec__42667,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42670){
var vec__42671 = p__42670;
var ns = cljs.core.nth.call(null,vec__42671,(0),null);
var name = cljs.core.nth.call(null,vec__42671,(1),null);
var selector = cljs.core.nth.call(null,vec__42671,(2),null);
...
return (function (p__42675){
var vec__42676 = p__42675;
var munged_name = cljs.core.nth.call(null,vec__42676,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__42676,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__42676,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__42674_SHARP_){
return (obj[cljs.core.first.call(null,p1__42674_SHARP_)]);
});})(name,sorted_matches,vec__42676,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
