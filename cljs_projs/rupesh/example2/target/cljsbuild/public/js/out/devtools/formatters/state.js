...
var len__40324__auto___42701 = arguments.length;
var i__40325__auto___42702 = (0);
while(true){
if((i__40325__auto___42702 < len__40324__auto___42701)){
args__40331__auto__.push((arguments[i__40325__auto___42702]));

var G__42703 = (i__40325__auto___42702 + (1));
i__40325__auto___42702 = G__42703;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__40332__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq42699){
var G__42700 = cljs.core.first.call(null,seq42699);
var seq42699__$1 = cljs.core.next.call(null,seq42699);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__42700,seq42699__$1);
});
...
return (p1__42704_SHARP_ === object);
});})(history))
,history);
});
