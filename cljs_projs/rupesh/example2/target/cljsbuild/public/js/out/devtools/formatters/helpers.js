...
var G__42681 = devtools.prefs.pref.call(null,v);
v = G__42681;
continue;
} else {
return v;
...
var and__39148__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__39148__auto__){
var and__39148__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
if(and__39148__auto____$1){
...
var or__39160__auto__ = (function (){try{if(!((value == null))){
...
}catch (e42684){var _e__41730__auto__ = e42684;
return false;
}})();
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
} else {
var or__39160__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e42688){var _e__41730__auto__ = e42688;
return false;
}})();
...
}catch (e42690){var _e__41730__auto__ = e42690;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__39148__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__39148__auto__)){
var and__39148__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__39148__auto____$1){
...
var and__39148__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__39148__auto__)){
...
var or__39160__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
} else {
...
var and__39148__auto__ = (function (){var or__39160__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
} else {
...
var vec__42692 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__42692,(0),null);
var name = cljs.core.nth.call(null,vec__42692,(1),null);
...
var and__39148__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__39148__auto__)){
...
var or__39160__auto__ = typeof value === 'string';
if(or__39160__auto__){
return or__39160__auto__;
} else {
var or__39160__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__42695_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42695_SHARP_);
}),template);
});
