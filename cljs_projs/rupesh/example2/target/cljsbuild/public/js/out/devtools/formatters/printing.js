...
var len__40324__auto___42710 = arguments.length;
var i__40325__auto___42711 = (0);
while(true){
if((i__40325__auto___42711 < len__40324__auto___42710)){
args__40331__auto__.push((arguments[i__40325__auto___42711]));

var G__42712 = (i__40325__auto___42711 + (1));
i__40325__auto___42711 = G__42712;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__40332__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42707){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__42708,G__42709,seq42707__$2);
});
...
if(cljs.core.truth_((function (){var or__39160__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__39785__auto__,writer__39786__auto__,opt__39787__auto__){
return cljs.core._write.call(null,writer__39786__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__39148__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__39148__auto__){
var or__39160__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42713_SHARP_){
return !((cljs.core.meta.call(null,p1__42713_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__42714__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__39160__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e42718){var _e__41730__auto__ = e42718;
return false;
}})();
if(cljs.core.truth_(or__39160__auto__)){
return or__39160__auto__;
...
}catch (e42720){var _e__41730__auto__ = e42720;
return false;
}}
})())){
...
var _STAR_current_state_STAR_42722 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__42723 = opts;
...
var markup_db = cljs.core.get.call(null,map__42723__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_42722;
}});
...
;
var temp__4655__auto___42727 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___42727)){
var managed_print_level_42728 = temp__4655__auto___42727;
var _STAR_print_level_STAR_42726_42729 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_42728;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_42726_42729,managed_print_level_42728,temp__4655__auto___42727,writer,opts,job_fn){
return (function (p1__42725_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__42725_SHARP_,null);
});})(_STAR_print_level_STAR_42726_42729,managed_print_level_42728,temp__4655__auto___42727,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_42726_42729;
}} else {
job_fn.call(null);
}
